...
///
- (void)setColorWithColor:(UIColor * _Nonnull)color withAlpha:(CGFloat)alpha redraw:(BOOL)redraw;
...
/// \param location <code>CGPoint</code> touch location.
///
- (void)sceneDoubleTappedWithLocation:(CGPoint)location;
@end
...
@property (nonatomic, strong) UIColor * _Nonnull objectColor;
@property (nonatomic, strong) UIColor * _Nonnull color;
@property (nonatomic, strong) UIColor * _Nonnull gridColor;
@property (nonatomic, strong) UIColor * _Nonnull frameColor;
@property (nonatomic, strong) UIColor * _Nonnull highlightColor;
